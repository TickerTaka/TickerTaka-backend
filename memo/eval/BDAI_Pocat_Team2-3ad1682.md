...
| 4 | 5대 설계문서 | 5 | ×1 | 5 | [S] | `memo/design/use-case-specification.md:1`, `component-design.md:1`, `interface-definition.md:122-205`, `sequence-diagram.md:1`, `erd.md:1-220` | 5종 존재, API/ERD/MCP/평가 경로까지 현재 구현 기준으로 정리됨 |
